...
def calculateAverageWaitTime():
    ...
    return round((((leftWaitTime + rightWaitTime + topWaitTime + bottomWaitTime)/60) / 4), 3)  # round to 3 dp
...
def simulationTime():
    ...
    while(True):
        ...
        if(timeElapsed == simTime):
            ...
            Data_Manager.save_Camera(f'{totalVehicles}', simTime, calculateAverageWaitTime())  # write data of the sim to the file
